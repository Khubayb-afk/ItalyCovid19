...
observed_deaths <- c(4, 0, 15, 65, 286, 1159, 3367, 8830, 19483) # (by age, Table 1 of Italy CDC report)
prop_deaths_lombardy <- 16466 / 33209  # scraped from official Italy Health Commission report, by date reporting end = 11-02-2020
                                 # note that the exact numbers differs slightly from Italy CDC paper. Assume proportion is correct
                                 # and apply this proportion to the number of deaths detailed in the Italy CDC paper.
...
# iss-covid19-bollettino-20200616:
ISS_observed_deaths <- 33209
ISS_observed_cases <- 238082
